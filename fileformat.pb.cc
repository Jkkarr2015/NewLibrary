...
#include "google/include/protobuf/stubs/port.h"
#include "google/include/protobuf/stubs/once.h"
#include "google/include/protobuf/io/coded_stream.h"
#include "google/include/protobuf/wire_format_lite_inl.h"
#include "google/include/protobuf/io/zero_copy_stream_impl_lite.h"
...
static ::std::string* MutableUnknownFieldsForBlob(
    Blob* ptr) {
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  ::google::protobuf::io::LazyStringOutputStream unknown_fields_string(
      ::google::protobuf::internal::NewPermanentCallback(
          &MutableUnknownFieldsForBlob, this));
...
static ::std::string* MutableUnknownFieldsForBlobHeader(
    BlobHeader* ptr) {
  return ptr->mutable_unknown_fields();
}
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  ::google::protobuf::io::LazyStringOutputStream unknown_fields_string(
      ::google::protobuf::internal::NewPermanentCallback(
          &MutableUnknownFieldsForBlobHeader, this));
  ::google::protobuf::io::CodedOutputStream unknown_fields_stream(
      &unknown_fields_string, false);
